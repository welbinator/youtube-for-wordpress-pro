<?php
/**
 * Helper functions for YouTube for WordPress Pro.
 *
...
function yt_for_wp_set_post_thumbnail_from_url( $post_id, $image_url ) {
	...
	// Save the image file to the uploads directory using WP_Filesystem.
	global $wp_filesystem;
	if ( empty( $wp_filesystem ) ) {
		require_once ABSPATH . '/wp-admin/includes/file.php';
		WP_Filesystem();
	}
	$wp_filesystem->put_contents( $file_path, $response['body'], FS_CHMOD_FILE );
