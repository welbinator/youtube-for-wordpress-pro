...
// Format date using gmdate to avoid timezone issues.
...
<div class="container">
	...
	<div class="video-description">
		<h2>Description</h2>
		<?php
		// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- apply_filters( 'the_content' ) is the standard WordPress pattern for rendering post content.
